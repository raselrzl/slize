...
export function ExclusiveBabyProduct() {
  return (
    <section className="bg-teal-900 text-white py-4 px-2 md:px-0">
      <div className="flex flex-col md:flex-row items-center justify-between md:items-stretch gap-6 max-w-7xl mx-auto">
               {/* Right side text section */}
        <div className="flex flex-col px-2 justify-center items-start gap-4 md:gap-6 md:w-1/2 text-left">
        ...
        <div className="relative w-full md:w-[600px] h-[200px] md:h-[300px] justify-end flex-shrink-0 overflow-hidden">
          <Image
            src="/featuredproductallbaby.png"
